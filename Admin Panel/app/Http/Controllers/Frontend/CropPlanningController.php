...
{
    public function __construct(private OpenRouterCropPlanningService $service) {}
    ...
    public function index(Request $request)
    {
        ...
        if (Auth::check()) {
            $plans = CropPlan::where('user_id', Auth::id())->latest()->take(10)->get();
    ...
    public function generate(CropPlanRequest $request)
    {
        ...
        return redirect()->back()->with(['plan' => $plan, 'success' => 'Crop plan generated successfully!']);
    }
