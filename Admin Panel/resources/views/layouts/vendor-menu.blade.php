@php
    $navItems = [
        ...
        ['label' => 'Orders', 'icon' => 'mdi-receipt-text-outline', 'active' => Request::is('vendor/orders*'), 'route' => route('vendor.orders.index')],
        ...
        ['label' => 'Inventory', 'icon' => 'mdi-package-variant-closed', 'active' => Request::is('vendor/inventory*'), 'route' => route('vendor.inventory.index')],
