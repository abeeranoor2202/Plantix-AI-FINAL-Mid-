...
<div class="container-fluid" style="padding-top: 24px; padding-bottom: 40px;">
    <div style="display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 32px;">
        <div>
            ...
            <p style="color: var(--agri-text-muted); margin: 4px 0 0 0;">Manage product taxonomy.</p>
        </div>
        <a href="{{ route('admin.categories.create') }}" class="btn-agri btn-agri-primary" style="text-decoration: none; display: flex; align-items: center; gap: 10px; font-weight: 700;">
            <i class="fas fa-plus"></i> {{ trans('lang.category_create') }}
        </a>
    </div>
    ...
    <div class="card-agri" style="padding: 0; overflow: hidden;">
        <div class="card-header bg-white border-bottom-0 pt-4 pb-3 px-4 d-flex justify-content-between align-items-center">
            ...
            <div class="input-group" style="width: 320px;">
                ...
                <input type="text" id="search-input" class="form-agri border-start-0" placeholder="Search categories..." style="margin-bottom: 0; border-radius: 0 10px 10px 0; height: 42px;">
            </div>
        </div>

        <div class="table-responsive">
            <table id="categoriesTable" class="table mb-0" style="vertical-align: middle;">
                ...
                @forelse($categories as $category)
                    <tr>
                        ...
                        <td class="px-4 py-3">
                            <span class="badge rounded-pill {{ $category->active ? 'bg-success' : 'bg-secondary' }}">{{ $category->active ? 'Active' : 'Inactive' }}</span>
                        </td>
                        <td class="px-4 py-3">
