...
<div class="row g-4">
    ...
    <div class="col-lg-8">
        ...
        <div class="card-agri mb-4" style="padding: 32px; background: white; border: none; box-shadow: 0 10px 30px rgba(0,0,0,0.04);">
            <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 24px; border-bottom: 1px solid var(--agri-border); padding-bottom: 16px;">
                ...
                <h5 style="margin: 0; font-weight: 800; color: var(--agri-text-heading); font-size: 16px; text-transform: uppercase; letter-spacing: 0.5px;">Basic Details</h5>
            </div>
            ...
            <div class="row g-4 mb-4">
                ...
                <div class="col-md-4">
                    <label class="agri-label">Base Price (PKR) <span class="text-danger">*</span></label>
        ...
        <div class="card-agri" style="padding: 32px; background: white; border: none; box-shadow: 0 10px 30px rgba(0,0,0,0.04);">
            <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 24px; border-bottom: 1px solid var(--agri-border); padding-bottom: 16px;">
                ...
                <h5 style="margin: 0; font-weight: 800; color: var(--agri-text-heading); font-size: 16px; text-transform: uppercase; letter-spacing: 0.5px;">Categorization & Stock</h5>
            </div>
    ...
    <div class="col-lg-4">
        ...
        <div class="card-agri mb-4" style="padding: 24px; background: white; border: none; box-shadow: 0 10px 30px rgba(0,0,0,0.04);">
            <label class="agri-label mb-3">Main Product Image</label>
            <div style="background: var(--agri-bg); border: 2px dashed var(--agri-border); border-radius: 20px; padding: 24px; text-align: center; position: relative;">
                @isset($product)
                    @if($product->image)
                        ...
                        <p style="font-size: 11px; font-weight: 700; color: var(--agri-primary);">REPLACE IMAGE</p>
                    @endif
                @endisset
        ...
        {{-- Asset Mosaic --}}
        <div class="card-agri mb-4" style="padding: 24px; background: white; border: none; box-shadow: 0 10px 30px rgba(0,0,0,0.04);">
            <label class="agri-label mb-3">Image Gallery</label>
            @isset($product)
            ...
            <p style="font-size: 10px; color: var(--agri-text-muted); margin: 8px 0 0 0;">Upload multiple images for your product.</p>
        </div>

        {{-- Governance Controls --}}
        <div class="card-agri" style="padding: 24px; background: white; border: none; box-shadow: 0 10px 30px rgba(0,0,0,0.04);">
            <label class="agri-label mb-3">Settings</label>
            ...
            <div style="display: flex; flex-direction: column; gap: 16px;">
                <div style="background: var(--agri-bg); padding: 14px; border-radius: 12px; display: flex; align-items: center; justify-content: space-between;">
                    <div style="display: flex; align-items: center; gap: 10px;">
                        ...
                        <span style="font-size: 13px; font-weight: 700; color: var(--agri-text-heading);">Active</span>
                    </div>
                ...
                <div style="background: var(--agri-bg); padding: 14px; border-radius: 12px; display: flex; align-items: center; justify-content: space-between;">
                    <div style="display: flex; align-items: center; gap: 10px;">
                        ...
                        <span style="font-size: 13px; font-weight: 700; color: var(--agri-text-heading);">Featured Product</span>
                    </div>
